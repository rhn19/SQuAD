...
from .configuration_electra import ElectraConfig, ELECTRA_PRETRAINED_CONFIG_ARCHIVE_MAP
...
if is_torch_available():
    ...
    from .modeling_electra import (ElectraPreTrainedModel, ElectraModel, ElectraForMaskedLM, ElectraForSequenceClassification, ElectraForQuestionAnswering,
                                    ElectraForQuestionAnsweringAVPool, load_tf_weights_in_electra, ELECTRA_PRETRAINED_CONFIG_ARCHIVE_MAP)
